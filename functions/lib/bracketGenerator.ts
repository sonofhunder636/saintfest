...
const CATEGORY_MAPPINGS: Record<CategoryKey, string> = {
  martyrs: 'Martyrs',
...
export class BracketGenerator {
  ...
  private async generateCategories(): Promise<BracketCategory[]> {
    ...
    for (let i = 0; i < this.config.selectedCategories.length; i++) {
      ...
      const category: BracketCategory = {
        ...
        name: CATEGORY_MAPPINGS[categoryKey as CategoryKey] || String(categoryKey),
        color: colors[i],
  ...
  static getAvailableCategories(): Array<{ key: CategoryKey; name: string }> {
