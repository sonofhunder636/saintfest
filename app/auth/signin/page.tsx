        ...
        <div className="mt-8 space-y-6">
          ...
          <form className="space-y-6" onSubmit={handleSignIn}>
            ...
            <div>
              <button
                type="submit"
                disabled={loading}
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 disabled:opacity-50 mb-3"
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Admin access only. Sign in with authorized Google account.
            </p>
          </div>
        </div>
      </div>
